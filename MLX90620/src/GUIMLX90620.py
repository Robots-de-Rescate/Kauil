...
class MyApp(Tk):
    def __init__(self):
        ...
        fr.grid()
	#self.Subscriber('chatter',Int16MultiArray,callback)
        ...
        self.A1=Canvas(fr, bg="#191990", height=self.h, width=self.w)  # Se hacen 64 canvas representando cada uno de los pixeles de la grafica y del sensor
...
z == "0xc" or z == "0xd" or z == "0xe" or z == "0xf"):
    ...
    def start_blinking(self): # Metodo para hechar a andar el programa
        self.do_blink = True
        #rospy.loginfo("going to listener")
        #listener()
        #self.A1.config(bg ="#191970")
	#callback
	self.blink()
    ...
    def blink(self):   # Una vez hechado a andar el programa se ejecuta este metodo, y es aqui donde los colores de cada canvas se ve modificado dependiendo la temp.
        ...
        if self.do_blink:
            ...
            self.after(5, self.blink)
        
	    

if __name__ == "__main__":
    thread.start_new_thread(initTK,())   
    listener()
