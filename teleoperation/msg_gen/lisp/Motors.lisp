...
(cl:defmethod cl:initialize-instance :after ((m <Motors>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Motors)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name teleoperation-msg:<Motors> is deprecated: use teleoperation-msg:Motors instead.")))

(cl:ensure-generic-function 'MotorLeft-val :lambda-list '(m))
(cl:defmethod MotorLeft-val ((m <Motors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teleoperation-msg:MotorLeft-val is deprecated.  Use teleoperation-msg:MotorLeft instead.")
  (MotorLeft m))

(cl:ensure-generic-function 'MotorRight-val :lambda-list '(m))
(cl:defmethod MotorRight-val ((m <Motors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teleoperation-msg:MotorRight-val is deprecated.  Use teleoperation-msg:MotorRight instead.")
  (MotorRight m))
