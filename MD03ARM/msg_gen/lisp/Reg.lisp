...
(cl:defmethod cl:initialize-instance :after ((m <Reg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Reg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name MD03ARM-msg:<Reg> is deprecated: use MD03ARM-msg:Reg instead.")))

(cl:ensure-generic-function 'B0_direction-val :lambda-list '(m))
(cl:defmethod B0_direction-val ((m <Reg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader MD03ARM-msg:B0_direction-val is deprecated.  Use MD03ARM-msg:B0_direction instead.")
  (B0_direction m))

(cl:ensure-generic-function 'B0_speed-val :lambda-list '(m))
(cl:defmethod B0_speed-val ((m <Reg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader MD03ARM-msg:B0_speed-val is deprecated.  Use MD03ARM-msg:B0_speed instead.")
  (B0_speed m))

(cl:ensure-generic-function 'B2_direction-val :lambda-list '(m))
(cl:defmethod B2_direction-val ((m <Reg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader MD03ARM-msg:B2_direction-val is deprecated.  Use MD03ARM-msg:B2_direction instead.")
  (B2_direction m))
