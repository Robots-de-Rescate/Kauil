...
(cl:defmethod cl:initialize-instance :after ((m <MD03>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MD03)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name MD03ARM-msg:<MD03> is deprecated: use MD03ARM-msg:MD03 instead.")))

(cl:ensure-generic-function 'MD03-val :lambda-list '(m))
(cl:defmethod MD03-val ((m <MD03>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader MD03ARM-msg:MD03-val is deprecated.  Use MD03ARM-msg:MD03 instead.")
  (MD03 m))
